...
class PDFExtractor:
    def __init__(self, root):
        ...
        tk.Label(root, text="Format: 1, 3-5, 7 (pages start from 1)", fg="gray").grid(row=1, column=3, padx=5, pady=5, sticky="w")
        ...
        tk.Button(root, text="Select", command=self.select_output).grid(row=2, column=2, padx=5, pady=5)

        tk.Button(root, text="Extract", command=self.extract_pages).grid(row=3, column=1, pady=10)
